...
import { ChevronLeft, ChevronRight, Eye, Info, ShieldCheck, X, Loader2, Plus, Trash2, ShoppingBag, Undo } from 'lucide-react';
    ...
    <AnimatePresence>
      {isOpen && (
        <>
          ...
          >
            <div className="p-6 sm:p-8 flex justify-between items-center border-b border-ink/5 bg-paper/80 backdrop-blur-md sticky top-0 z-20">
              <div className="flex items-center gap-4">
                <span className="font-brand font-bold text-lg sm:text-xl md:text-2xl uppercase tracking-tighter text-ink leading-none">
                  {(() => {
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-6">
                      ...
                      <div className="w-full sm:w-auto shrink-0 flex flex-col gap-2">
                        <button
                          onClick={() => {
                            if (!selectedSize) {
                              setGlobalError("PLEASE SELECT A SIZE BEFORE ADDING TO BAG");
                              return;
                            }
